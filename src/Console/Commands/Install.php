...
namespace Wyzo\GraphQLAPI\Console\Commands;

use Illuminate\Console\Command;
use Wyzo\GraphQLAPI\Providers\GraphQLAPIServiceProvider;
...
class Install extends Command
{
     ...
     * @var string
     */
    protected $signature = 'wyzo-graphql:install';
     ...
     * @var string
     */
    protected $description = 'Installing Wyzo GraphQL API Extension';
    ...
    public function handle()
    {
        ...
        $this->comment('Success: Wyzo GraphQL API has been configured successfully.');
    }
}
