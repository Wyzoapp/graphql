...
namespace Wyzo\GraphQLAPI\Http\Controllers\Admin;

use Illuminate\Http\JsonResponse;
use Illuminate\Support\Facades\Event;
use Illuminate\Support\Facades\Storage;
use Wyzo\Admin\Http\Controllers\Controller;
use Wyzo\Admin\Http\Requests\MassDestroyRequest;
use Wyzo\Admin\Http\Requests\MassUpdateRequest;
use Wyzo\Category\Repositories\CategoryRepository;
use Wyzo\GraphQLAPI\DataGrids\PushNotificationDataGrid;
use Wyzo\GraphQLAPI\Http\Requests\NotificationRequest;
...
class NotificationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('wyzo_graphql::admin.settings.push_notification.index');
    }
    ...
    {
        return view('wyzo_graphql::admin.settings.push_notification.create');
    }
    ...
    public function store(NotificationRequest $request)
    {
        ...
        return to_route('admin.settings.push_notification.index')
            ->with('success', trans('wyzo_graphql::app.admin.settings.notification.create-success'));
    }
    ...
    public function edit(int $id)
    {
        ...
        return view('wyzo_graphql::admin.settings.push_notification.edit')
    ...
    public function update(NotificationRequest $request, int $id)
    {
        ...
        return to_route('admin.settings.push_notification.index')
            ->with('success', trans('wyzo_graphql::app.admin.settings.notification.update-success'));
    }
    ...
    public function destroy(int $id): JsonResponse
    {
        try {
            ...
            return new JsonResponse([
                'message' => trans('wyzo_graphql::app.admin.settings.notification.delete-success'),
            ]);
        } catch (\Exception $e) {
            return new JsonResponse([
                'message' => trans('wyzo_graphql::app.admin.settings.notification.delete-failed'),
            ], 500);
        }
    }
    ...
    public function massDestroy(MassDestroyRequest $massDestroyRequest): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => trans('wyzo_graphql::app.admin.settings.notification.mass-delete-success'),
        ]);
    }
    ...
    public function massUpdate(MassUpdateRequest $request): JsonResponse
    {
        ...
        return new JsonResponse([
            'message' => trans('wyzo_graphql::app.admin.settings.notification.mass-update-success'),
        ], 200);
    }
    ...
    public function sendNotification($id)
    {
        ...
        if (isset($result->message_id)) {
            session()->flash('success', trans('wyzo_graphql::app.admin.settings.notification.send-success'));
        } else {
            $message = $result;
    ...
    public function exist()
    {
        ...
        if ($data['selectedType'] == 'product') {
            ...
            return new JsonResponse([
                'value'   => false,
                'message' => trans('wyzo_graphql::app.admin.settings.notification.product-not-found'),
                'type'    => 'product',
            ], 401);
        }
        ...
        if ($data['selectedType'] == 'category') {
            ...
            return new JsonResponse([
                'value'   => false,
                'message' => trans('wyzo_graphql::app.admin.settings.notification.category-not-found'),
                'type'    => 'category',
            ], 401);
        }
    }
