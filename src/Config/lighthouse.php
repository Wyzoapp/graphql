...
return [
    ...
    */
    'route' => [
        ...
        'middleware' => [
            ...
            \Wyzo\GraphQLAPI\Http\Middleware\LocaleMiddleware::class,

            // Validate Currency in request
            \Wyzo\GraphQLAPI\Http\Middleware\CurrencyMiddleware::class,

            // Rate Limit the request
            \Wyzo\GraphQLAPI\Http\Middleware\RateLimitMiddleware::class,
        ],
    ...
    */
    ...
    |
    */
    'schema_path' => base_path('vendor/wyzo/graphql-api/src/graphql/schema.graphql'),
    ...
    */
    'namespaces' => [
        'subscriptions' => 'Wyzo\\GraphQLAPI\\Subscriptions',
        'interfaces'    => 'Wyzo\\GraphQLAPI\\Interfaces',
        'unions'        => 'Wyzo\\GraphQLAPI\\Unions',
        'scalars'       => 'Wyzo\\GraphQLAPI\\Scalars',

        'queries' => [
            'Wyzo\\GraphQLAPI\\Queries',
        ],

        'mutations' => [
            'Wyzo\\GraphQLAPI\\Mutations',
        ],

        'directives' => [
            'Wyzo\\GraphQLAPI\\Directives',
        ],

        'validators' => [
            'Wyzo\\GraphQLAPI\\Validators',
        ],

        'models' => [
            'App',
            'Wyzo\\GraphQLAPI\\Models',
        ],
    ],
