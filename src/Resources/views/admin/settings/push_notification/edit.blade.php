...
<x-admin::layouts>
    <!-- Title of the page -->
    <x-slot:title>
        @lang('wyzo_graphql::app.admin.settings.notification.edit.edit-notification')
    </x-slot:title>
            ...
            >
                <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
                    ...
                    <div class="flex items-center gap-x-2.5">
                        ...
                        >
                            @lang('wyzo_graphql::app.admin.settings.notification.edit.back-btn')
                        </a>
                        ...
                        @if (
                            ...
                            >
                                @lang('wyzo_graphql::app.admin.settings.notification.edit.send-title')
                            </a>
                        @endif
                        ...
                        <button
                            ...
                            class="primary-button"
                        >
                            @lang('wyzo_graphql::app.admin.settings.notification.edit.update-btn-title')
                        </button>
                    </div>
                </div>
                ...
                <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
                    ...
                    <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                        ...
                        <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                            <p class="mb-4 text-base font-semibold text-gray-800 dark:text-white">
                                @lang('wyzo_graphql::app.admin.settings.notification.edit.general')
                            </p>
                            ...
                            <x-admin::form.control-group class="mb-2.5">
                                <x-admin::form.control-group.label class="required">
                                    @lang('wyzo_graphql::app.admin.settings.notification.edit.title')
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    rules="required"
                                    :label="trans('wyzo_graphql::app.admin.settings.notification.edit.title')"
                                    :placeholder="trans('wyzo_graphql::app.admin.settings.notification.edit.title')"
                                />
                        ...
                        <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                            <p class="mb-4 text-base font-semibold text-gray-800 dark:text-white">
                                @lang('wyzo_graphql::app.admin.settings.notification.edit.content-and-image')
                            </p>
                            ...
                            <v-description>
                                <x-admin::form.control-group class="mb-2.5">
                                    <x-admin::form.control-group.label class="required">
                                        @lang('wyzo_graphql::app.admin.settings.notification.edit.notification-content')
                                    </x-admin::form.control-group.label>
                            ...
                            <div class="flex flex-col gap-2">
                                <p class="text-gray-800 dark:text-white font-medium">
                                    @lang('wyzo_graphql::app.admin.settings.notification.edit.image')
                                </p>
                    ...
                    <div class="flex w-[360px] max-w-full flex-col gap-2">
                        ...
                        <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                            <p class="mb-4 text-base font-semibold text-gray-800 dark:text-white">
                                @lang('wyzo_graphql::app.admin.settings.notification.edit.settings')
                            </p>

                            <!-- Visible in menu -->
                            <x-admin::form.control-group>
                                <x-admin::form.control-group.label class="text-gray-800 dark:text-white font-medium">
                                    @lang('wyzo_graphql::app.admin.settings.notification.edit.status')
                                </x-admin::form.control-group.label>
                            ...
                            <x-admin::form.control-group class="mb-2.5">
                                <x-admin::form.control-group.label class="required">
                                    @lang('wyzo_graphql::app.admin.settings.notification.edit.notification-type')
                                </x-admin::form.control-group.label>
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    :label="trans('wyzo_graphql::app.admin.settings.notification.edit.notification-type')"
                                ...
                                >
                                    ...
                                    @foreach(['others', 'product', 'category'] as $type)
                                        ...
                                        >
                                            @lang('wyzo_graphql::app.admin.settings.notification.edit.option-type.'. $type)
                                        </option>
                                    @endforeach
                                </x-admin::form.control-group.control>
                            ...
                            >
                                <x-admin::form.control-group.label class="required">
                                    @lang('wyzo_graphql::app.admin.settings.notification.edit.product-cat-id')
                                </x-admin::form.control-group.label>
                                ...
                                <v-field
                                    ...
                                    label="{{ trans('wyzo_graphql::app.admin.settings.notification.edit.product-cat-id') }}"
                                ...
                                >
                                    <input
                                        ...
                                        placeholder="{{ trans('wyzo_graphql::app.admin.settings.notification.edit.product-cat-id') }}"
                                        v-code
                                    >
                                </v-field>
                        ...
                        <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                            <p class="required pb-2.5 text-base font-semibold text-gray-800 dark:text-white">
                                @lang('wyzo_graphql::app.admin.settings.notification.edit.store-view')
                            </p>
                            ...
                            @foreach (core()->getAllChannels() as $channel)
                                <x-admin::form.control-group class="!mb-2 flex select-none items-center gap-2.5 last:!mb-0">
                                    <x-admin::form.control-group.control
                                        ...
                                        rules="required"
                                        :label="trans('wyzo_graphql::app.admin.settings.notification.edit.store-view')"
