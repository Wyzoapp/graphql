...
use Wyzo\Product\Helpers\Toolbar;
use Wyzo\Product\Repositories\ElasticSearchRepository;
use Wyzo\Product\Repositories\ProductRepository;
use Wyzo\Theme\Repositories\ThemeCustomizationRepository;
...
class HomePageQuery extends BaseFilter
{
     ...
     *
     * @return \Wyzo\Core\Contracts\Channel
     */
    ...
    public function getCategories(mixed $rootValue, array $args)
    {
        ...
        throw new CustomException(trans('wyzo_graphql::app.admin.response.error.invalid-parameter'));
    }
    ...
    public function getAllProducts(mixed $rootValue, array $args)
    {
        ...
        return [
            'paginator_info' => wyzo_graphql()->getPaginatorInfo($products),
