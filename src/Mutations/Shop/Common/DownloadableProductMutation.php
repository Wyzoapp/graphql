    ...
    public function downloadSample(mixed $rootValue, array $args)
    {
        ...
        if ($args['type'] === 'link') {
            ...
            if (! $productDownloadableLink) {
                throw new CustomException(trans('wyzo_graphql::app.shop.downloadable-products.download-sample.link-not-found'));
            }
            ...
            if (! $productDownloadableSample) {
                throw new CustomException(trans('wyzo_graphql::app.shop.downloadable-products.download-sample.sample-not-found'));
            }
