    ...
    public function forgot(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        try {
            ...
            if ($response == Password::RESET_LINK_SENT) {
                return [
                    'success' => true,
                    'message' => trans('wyzo_graphql::app.shop.customers.forgot-password.reset-link-sent'),
                ];
            }
            ...
            if ($response == Password::RESET_THROTTLED) {
                return [
                    'success' => true,
                    'message' => trans('wyzo_graphql::app.shop.customers.forgot-password.already-sent'),
                ];
            }

            throw new CustomException(trans('wyzo_graphql::app.shop.customers.forgot-password.email-not-exist'));
