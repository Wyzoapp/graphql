...
use Wyzo\Sales\Repositories\DownloadableLinkPurchasedRepository;
use Wyzo\Shop\Http\Controllers\Controller;
...
class DownloadableMutation extends Controller
{
    ...
    public function download(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if (
            ...
            throw new CustomException(trans('wyzo_graphql::app.shop.customers.account.downloadable-products.not-auth'));
        }
        ...
        if (
            ...
            throw new CustomException(trans('wyzo_graphql::app.shop.customers.account.downloadable-products.payment-error'));
        }
        ...
        if (
            ...
            throw new CustomException(trans('wyzo_graphql::app.shop.customers.account.downloadable-products.download-error'));
        }
