...
use Wyzo\Inventory\Repositories\InventorySourceRepository;
...
class InventorySourceMutation extends Controller
{
    ...
    public function store(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        try {
            ...
            return [
                'success'          => true,
                'message'          => trans('wyzo_graphql::app.admin.settings.inventory-sources.create-success'),
    ...
    public function update(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if (! $inventorySource) {
            throw new CustomException(trans('wyzo_graphql::app.admin.settings.inventory-sources.not-found'));
        }
        ...
        try {
            ...
            return [
                'success'          => true,
                'message'          => trans('wyzo_graphql::app.admin.settings.inventory-sources.update-success'),
                'inventory_source' => $inventorySource,
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
    ...
    public function delete(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if ($this->inventorySourceRepository->count() == 1) {
            throw new CustomException(trans('wyzo_graphql::app.admin.settings.inventory-sources.last-delete-error'));
        }
        ...
        try {
            ...
            return [
                'success' => true,
                'message' => trans('wyzo_graphql::app.admin.settings.inventory-sources.delete-success'),
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
        }
