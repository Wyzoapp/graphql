...
use Wyzo\Tax\Repositories\TaxRateRepository;
...
class TaxRateMutation extends Controller
{
    ...
    public function store(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        try {
            ...
            return [
                'success'  => true,
                'message'  => trans('wyzo_graphql::app.admin.settings.tax-rates.create-success'),
                'tax_rate' => $taxRate,
            ];
        } catch (\Exception $e) {
    ...
    public function update(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if (! $taxRate) {
            throw new CustomException(trans('wyzo_graphql::app.admin.settings.tax-rate.not-found'));
        }
        ...
        try {
            ...
            return [
                'success'  => true,
                'message'  => trans('wyzo_graphql::app.admin.settings.tax-rates.update-success'),
                'tax_rate' => $taxRate,
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
    ...
    public function delete(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if (! $taxRate) {
            throw new CustomException(trans('wyzo_graphql::app.admin.settings.tax-rates.not-found'));
        }
        ...
        try {
            ...
            return [
                'success'  => true,
                'message'  => trans('wyzo_graphql::app.admin.settings.tax-rates.delete-success'),
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
        }
