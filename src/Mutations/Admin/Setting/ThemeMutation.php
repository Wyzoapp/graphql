...
class ThemeMutation extends Controller
{
    ...
    public function store(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        return [
            'success' => true,
            'message' => trans('wyzo_graphql::app.admin.settings.themes.create-success'),
            'theme'   => $theme,
        ];
    }
    ...
    public function update(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if (! $themeCustomization) {
            throw new CustomException(trans('wyzo_graphql::app.admin.settings.themes.not-found'));
        }
        ...
        return [
            'success' => true,
            'message' => trans('wyzo_graphql::app.admin.settings.themes.update-success'),
            'theme'   => $theme,
        ];
    }
    ...
    public function delete(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        return [
            'success' => true,
            'message' => trans('wyzo_graphql::app.admin.settings.themes.delete-success'),
        ];
    }
}
