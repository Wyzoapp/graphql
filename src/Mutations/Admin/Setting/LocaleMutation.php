...
use Wyzo\Core\Repositories\LocaleRepository;
...
class LocaleMutation extends Controller
{
    ...
    public function store(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        try {
            ...
            wyzo_graphql()->uploadImage($locale, $imageUrl, 'locale/', 'logo_path');

            return [
                'success' => true,
                'message' => trans('wyzo_graphql::app.admin.settings.locales.create-success'),
                'locale'  => $locale,
            ];
        } catch (\Exception $e) {
    ...
    public function update(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if (! $locale) {
            throw new CustomException(trans('wyzo_graphql::app.admin.settings.locales.not-found'));
        }
        ...
        try {
            ...
            return [
                'success' => true,
                'message' => trans('wyzo_graphql::app.admin.settings.locales.update-success'),
                'locale'  => $locale,
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
    ...
    public function delete(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if (core()->getCurrentLocale()->code == $locale->code) {
            throw new CustomException(trans('wyzo_graphql::app.admin.settings.locales.default-delete-error'));
        }

        if ($this->localeRepository->count() == 1) {
            throw new CustomException(trans('wyzo_graphql::app.admin.settings.locales.last-delete-error'));
        }
        ...
        try {
            ...
            return [
                'success' => true,
                'message' => trans('wyzo_graphql::app.admin.settings.locales.delete-success'),
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
        }
