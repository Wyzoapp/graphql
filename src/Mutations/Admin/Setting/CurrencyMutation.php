...
class CurrencyMutation extends Controller
{
    ...
    public function store(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        try {
            ...
            return [
                'success'  => true,
                'message'  => trans('wyzo_graphql::app.admin.settings.currencies.create-success'),
                'currency' => $currency,
            ];
        } catch (\Exception $e) {
    ...
    public function update(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if (! $currency) {
            throw new CustomException(trans('wyzo_graphql::app.admin.settings.currencies.not-found'));
        }
        ...
        try {
            ...
            return [
                'success'  => true,
                'message'  => trans('wyzo_graphql::app.admin.settings.currencies.update-success'),
                'currency' => $currency,
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
    ...
    public function delete(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if ($this->currencyRepository->count() == 1) {
            throw new CustomException(trans('wyzo_graphql::app.admin.settings.currencies.last-delete-error'));
        }

        if (core()->getBaseCurrencyCode() == $currency->code) {
            throw new CustomException(trans('wyzo_graphql::app.admin.settings.currencies.default-delete-error'));
        }
        ...
        try {
            ...
            return [
                'success' => true,
                'message' => trans('wyzo_graphql::app.admin.settings.currencies.delete-success'),
            ];
        } catch (\Exception $e) {
            throw new CustomException(trans('wyzo_graphql::app.admin.settings.currencies.delete-error'));
        }
    }
}
