...
namespace Wyzo\GraphQLAPI\Mutations\Admin\Configuration;

use Nuwave\Lighthouse\Support\Contracts\GraphQLContext;
use Wyzo\Admin\Http\Controllers\Controller;
use Wyzo\Core\Repositories\CoreConfigRepository;
...
class CustomScriptMutation extends Controller
{
    ...
    public function updateCustomScript(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        try {
            ...
            return [
                'success'        => true,
                'message'        => trans('wyzo_graphql::app.admin.configuration.index.general.content.custom-script.update-success'),
                'custom_scripts' => [
                    'css'        => $css,
