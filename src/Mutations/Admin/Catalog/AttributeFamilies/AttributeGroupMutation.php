...
class AttributeGroupMutation extends Controller
{
    ...
    public function store(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        try {
            ...
            return [
                'success'         => true,
                'message'         => trans('wyzo_graphql::app.admin.catalog.attribute-groups.create-success'),
    ...
    public function update(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if (! $attributeGroup) {
            throw new CustomException(trans('wyzo_graphql::app.admin.catalog.attribute-groups.not-found'));
        }
        ...
        try {
            ...
            return [
                'success'         => true,
                'message'         => trans('wyzo_graphql::app.admin.catalog.attribute-groups.update-success'),
                'attribute_group' => $attributeGroup,
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
    ...
    public function delete(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if ($attributeGroup->is_user_defined === 0) {
            throw new CustomException(trans('wyzo_graphql::app.admin.catalog.attribute-groups.user-define-error'));
        }
        ...
        try {
            ...
            return [
                'success' => true,
                'message' => trans('wyzo_graphql::app.admin.catalog.attribute-groups.delete-success'),
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
        }
