...
namespace Wyzo\GraphQLAPI\Mutations\Admin\Catalog\AttributeFamilies;

use App\Http\Controllers\Controller;
use Illuminate\Support\Facades\Event;
use Nuwave\Lighthouse\Support\Contracts\GraphQLContext;
use Wyzo\Attribute\Repositories\AttributeFamilyRepository;
use Wyzo\Attribute\Repositories\AttributeGroupRepository;
...
class AttributeFamilyMutation extends Controller
{
    ...
    public function store(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        try {
            ...
            return [
                'success'          => true,
                'message'          => trans('wyzo_graphql::app.admin.catalog.attribute-families.create-success'),
    ...
    public function update(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if (! $attributeFamily) {
            throw new CustomException(trans('wyzo_graphql::app.admin.catalog.attribute-families.not-found'));
        }
        ...
        try {
            ...
            return [
                'success'          => true,
                'message'          => trans('wyzo_graphql::app.admin.catalog.attribute-families.update-success'),
                'attribute_family' => $attributeFamily,
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
    ...
    public function delete(mixed $rootValue, array $args, GraphQLContext $context)
    {
        if ($this->attributeFamilyRepository->count() == 1) {
            throw new CustomException(trans('wyzo_graphql::app.admin.catalog.attribute-families.last-delete-error'));
        }
        ...
        if ($attributeFamily->products()->count()) {
            throw new CustomException(trans('wyzo_graphql::app.admin.catalog.attribute-families.attribute-product-error'));
        }
        ...
        try {
            ...
            return [
                'success' => true,
                'message' => trans('wyzo_graphql::app.admin.catalog.attribute-families.delete-success'),
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
        }
