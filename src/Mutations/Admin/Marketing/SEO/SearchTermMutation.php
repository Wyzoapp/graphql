...
use Wyzo\Marketing\Repositories\SearchTermRepository;
...
class SearchTermMutation extends Controller
{
    ...
    public function store(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        try {
            ...
            return [
                'success'     => true,
                'message'     => trans('wyzo_graphql::app.admin.marketing.seo.search-terms.create-success'),
    ...
    public function update(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if (! $searchTerm) {
            throw new CustomException(trans('wyzo_graphql::app.admin.marketing.seo.search-terms.not-found'));
        }
        ...
        try {
            ...
            return [
                'success'     => true,
                'message'     => trans('wyzo_graphql::app.admin.marketing.seo.search-terms.update-success'),
                'search_term' => $searchTerm,
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
    ...
    public function delete(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        try {
            ...
            return [
                'success' => true,
                'message' => trans('wyzo_graphql::app.admin.marketing.seo.search-terms.delete-success'),
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
        }
