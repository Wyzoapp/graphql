...
namespace Wyzo\GraphQLAPI\Mutations\Admin\Marketing\SEO;

use Illuminate\Support\Facades\Event;
use Nuwave\Lighthouse\Support\Contracts\GraphQLContext;
use Wyzo\Admin\Http\Controllers\Controller;
use Wyzo\GraphQLAPI\Validators\CustomException;
use Wyzo\Marketing\Repositories\SearchSynonymRepository;
...
class SearchSynonymMutation extends Controller
{
    ...
    public function store(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        try {
            ...
            return [
                'success'        => true,
                'message'        => trans('wyzo_graphql::app.admin.marketing.seo.search-synonyms.create-success'),
    ...
    public function update(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if (! $searchSynonym) {
            throw new CustomException(trans('wyzo_graphql::app.admin.marketing.seo.search-synonyms.not-found'));
        }
        ...
        try {
            ...
            return [
                'success'        => true,
                'message'        => trans('wyzo_graphql::app.admin.marketing.seo.search-synonyms.update-success'),
                'search_synonym' => $searchSynonym,
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
    ...
    public function delete(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        try {
            ...
            return [
                'success' => true,
                'message' => trans('wyzo_graphql::app.admin.marketing.seo.search-synonyms.delete-success'),
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
        }
