...
class CartRuleMutation extends Controller
{
    ...
    public function store(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        try {
            ...
            return [
                'success'   => true,
                'message'   => trans('wyzo_graphql::app.admin.marketing.promotions.cart-rules.create-success'),
                'cart_rule' => $cartRule,
            ];
        } catch (\Exception $e) {
    ...
    public function update(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if (! $cartRule) {
            throw new CustomException(trans('wyzo_graphql::app.admin.marketing.promotions.cart-rules.not-found'));
        }
        ...
        try {
            ...
            return [
                'success'   => true,
                'message'   => trans('wyzo_graphql::app.admin.marketing.promotions.cart-rules.update-success'),
                'cart_rule' => $cartRule,
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
    ...
    public function delete(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        try {
            ...
            return [
                'success' => true,
                'message' => trans('wyzo_graphql::app.admin.marketing.promotions.cart-rules.delete-success'),
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
        }
