...
use Wyzo\Customer\Repositories\CustomerNoteRepository;
...
class CustomerMutation extends Controller
{
    ...
    public function store(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        try {
            ...
            return [
                'success'  => true,
                'message'  => trans('wyzo_graphql::app.admin.customers.customers.create-success'),
                'customer' => $customer,
            ];
        } catch (\Exception $e) {
    ...
    public function update(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        try {
            ...
            return [
                'success'  => true,
                'message'  => trans('wyzo_graphql::app.admin.customers.customers.update-success'),
                'customer' => $customer,
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
    ...
    public function delete(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        try {
            if ($this->customerRepository->haveActiveOrders($customer)) {
                throw new CustomException(trans('wyzo_graphql::app.admin.customers.customers.delete-order-pending'));
            }
            ...
            return [
                'success' => true,
                'message' => trans('wyzo_graphql::app.admin.customers.customers.delete-success'),
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
        }
    ...
    public function storeNotes(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        try {
            ...
            return [
                'success' => true,
                'message' => trans('wyzo_graphql::app.admin.customers.customers.note-created-success'),
                'note'    => $note,
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
