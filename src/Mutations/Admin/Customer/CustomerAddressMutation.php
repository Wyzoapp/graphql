...
use Wyzo\Customer\Rules\VatIdRule;
...
class CustomerAddressMutation extends Controller
{
    ...
    public function store(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if (! $customer) {
            throw new CustomException(trans('wyzo_graphql::app.admin.customers.customers.not-found'));
        }
        ...
        try {
            ...
            return [
                'success' => true,
                'message' => trans('wyzo_graphql::app.admin.customers.addressess.create-success'),
    ...
    public function update(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if (! $customerAddress) {
            throw new CustomException(trans('wyzo_graphql::app.admin.customers.addressess.not-found'));
        }
        ...
        try {
            ...
            return [
                'success' => true,
                'message' => trans('wyzo_graphql::app.admin.customers.addressess.update-success'),
                'address' => $customerAddress,
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
    ...
    public function setAsDefaultAddress(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        try {
            ...
            return [
                'success' => true,
                'message' => trans('wyzo_graphql::app.admin.customers.addressess.default-update-success'),
                'address' => $address,
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
    ...
    public function delete(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        try {
            ...
            return [
                'success' => true,
                'message' => trans('wyzo_graphql::app.admin.customers.addressess.delete-success'),
            ];
