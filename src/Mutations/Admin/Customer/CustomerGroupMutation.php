...
class CustomerGroupMutation extends Controller
{
    ...
    public function store(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        try {
            ...
            return [
                'success'        => true,
                'message'        => trans('wyzo_graphql::app.admin.customers.groups.create-success'),
    ...
    public function update(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if (! $customerGroup) {
            throw new CustomException(trans('wyzo_graphql::app.admin.customers.groups.not-found'));
        }
        ...
        try {
            ...
            return [
                'success'        => true,
                'message'        => trans('wyzo_graphql::app.admin.customers.groups.update-success'),
                'customer_group' => $customerGroup,
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
    ...
    public function delete(mixed $rootValue, array $args, GraphQLContext $context)
    {
        ...
        if (! $customerGroup->is_user_defined) {
            throw new CustomException(trans('wyzo_graphql::app.admin.customers.groups.user-define-error'));
        }

        if (count($customerGroup->customers)) {
            throw new CustomException(trans('wyzo_graphql::app.admin.customers.groups.customer-associate'));
        }
        ...
        try {
            ...
            return [
                'success' => true,
                'message' => trans('wyzo_graphql::app.admin.customers.groups.delete-success'),
            ];
        } catch (\Exception $e) {
            throw new CustomException($e->getMessage());
        }
